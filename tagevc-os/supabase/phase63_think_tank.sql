-- Tage VC OS Think Tank — personal Grok advisor (shared UDL with subsidiary portals)
-- Idempotent with phase_think_tank_os / phase42_r619_think_tank
...
grant select, insert, update, delete on public.os_think_tank_conversations to service_role;
grant select, insert, update, delete on public.os_think_tank_messages to service_role;
