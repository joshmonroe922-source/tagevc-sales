...
await setStep(
  ...
  [
    ...
    'UPN / primary SMTP dennis@recruit619.com',
    'O365_BUSINESS_PREMIUM assigned (skuId f245ecc8-75af-4f8e-b61f-27d8114de5f3), usageLocation US',
    'Exchange Online mailbox confirmed: mailFolders returns Inbox/Drafts/Sent Items, proxyAddresses SMTP:dennis@recruit619.com',
...
await setStep(
  ...
  [
    ...
    '  Add-MailboxPermission -Identity dennis@recruit619.com -User joshmonroe@tagevc.com -AccessRights FullAccess -InheritanceType All',
