...
export const DEFAULT_MERGE_FIELDS: MergeField[] = [
  ...
  { object: 'job', api_name: 'title', label: 'Job title', data_type: 'text', sensitive: false, insert_token: '{{job.title | default: "this role"}}', sample_value: 'Staff Recruiter' },
  { object: 'nda', api_name: 'document_name', label: 'NDA document', data_type: 'text', sensitive: false, insert_token: '{{nda.document_name | default: "NDA"}}', sample_value: 'Mutual NDA' },
  { object: 'hr', api_name: 'start_date', label: 'HR start date', data_type: 'date', sensitive: false, insert_token: '{{hr.start_date}}', sample_value: '2026-08-15' },
