...
describe('Phase 43 snapshot firm-wide verify and production cold HEAD', () => {
  ...
  it('wires phase43 helpers into API and admin UI without private keys', () => {
    ...
    expect(route).toMatch(
      /getSnapshotPhase43VerifyColdDashboard|getSnapshotPhase44OpsDashboard|getSnapshotPhase45OpsDashboard|getSnapshotPhase46OpsDashboard|getSnapshotPhase47OpsDashboard|getSnapshotPhase48OpsDashboard|getSnapshotPhase49OpsDashboard|getSnapshotPhase50OpsDashboard/,
    );
