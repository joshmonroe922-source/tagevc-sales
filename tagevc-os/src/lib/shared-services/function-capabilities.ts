...
> = {
  finance: (entityId) => [
    ...
    {
      id: 'fin-af',
      title: 'Tage VC A&F Finance',
      description: 'Budgets · cash · forecasts · KPIs · loans · company NW.',
      href: withEntity('/shared-services/af/finance', entityId),
      badge: 'Live',
    },
    {
      id: 'fin-af-accounting',
      title: 'Tage VC A&F Accounting',
      description: 'GL · AR/AP · banks · close · commissions.',
      href: withEntity('/shared-services/af/accounting', entityId),
      badge: 'Live',
    },
    {
      id: 'fin-credit',
      title: 'Business credit',
      description: 'Credit monitoring for the firm portfolio (Visionary Personal).',
