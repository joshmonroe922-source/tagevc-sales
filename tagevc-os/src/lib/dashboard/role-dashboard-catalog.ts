...
const CATALOG: Record<AppRole, RoleDashboardKpiDef[]> = {
  ...
  admin: [
    { kpi_id: 'task_ontime', label: 'Task on-time delivery', description: 'Completion', kind: 'leading' },
    { kpi_id: 'admin_turnaround', label: 'Response / turnaround', description: 'Speed', kind: 'leading' },
    { kpi_id: 'calendar_accuracy', label: 'Calendar / meeting coordination', description: 'Accuracy', kind: 'leading' },
    { kpi_id: 'doc_completeness', label: 'Document management', description: 'Completeness / retrieval', kind: 'leading' },
    { kpi_id: 'expense_timeliness', label: 'Expense / travel processing', description: 'Timeliness / accuracy', kind: 'leading' },
    { kpi_id: 'request_volume', label: 'Request volume / resolution', description: 'Load', kind: 'leading' },
    { kpi_id: 'admin_errors', label: 'Admin error rates', description: 'Quality', kind: 'health' },
    { kpi_id: 'stakeholder_sat', label: 'Stakeholder satisfaction', description: 'Feedback', kind: 'lagging' },
    { kpi_id: 'logistics', label: 'Logistics metrics', description: 'Where applicable', kind: 'leading' },
    { kpi_id: 'escalation_handling', label: 'Escalation handling', description: 'Effectiveness', kind: 'leading' },
  ],
};
