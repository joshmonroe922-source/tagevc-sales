...
import { TechnologyStackAdminClient } from '@/components/shared-services/technology-stack-admin-client';
import { SscFunctionHomeChromeServer } from '@/components/shared-services/ssc-function-home-chrome-server';
import {
  getTechnologyStackView,
  listVendorContracts,
  listVendorPaymentsEnriched,
...
export default async function TechnologyStackPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {canWrite ? (
        <TechnologyStackAdminClient contracts={contracts} payments={payments} />
      ) : (
        <section>
